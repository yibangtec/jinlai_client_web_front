		...
		<fieldset>
			...
			<input name=id type=hidden value="<?php echo $item[$this->id_name] ?>">
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=nature type=text value="<?php echo $item['nature'] ?>" placeholder="商品性质" required>
							</div>
						</div>
						<div class=form-group>
							<label for=level class="col-sm-2 control-label">分类级别</label>
							<div class=col-sm-10>
								<input class=form-control name=level type=text value="<?php echo $item['level'] ?>" placeholder="分类级别" required>
							</div>
						</div>
						<div class=form-group>
						...
						<div class=form-group>
							...
							<div class=col-sm-10>
								<input class=form-control name=description type=text value="<?php echo $item['description'] ?>" placeholder="描述" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_name class="col-sm-2 control-label">自定义域名</label>
							<div class=col-sm-10>
								<input class=form-control name=url_name type=text value="<?php echo $item['url_name'] ?>" placeholder="自定义域名" required>
							</div>
						</div>
						<div class=form-group>
							<label for=url_image class="col-sm-2 control-label">形象图URL</label>
							<div class=col-sm-10>
								<input class=form-control name=url_image type=text value="<?php echo $item['url_image'] ?>" placeholder="形象图URL" required>
							</div>
						</div>
						<div class=form-group>
