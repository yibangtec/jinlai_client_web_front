	      ...
	      <!--<div class="swiper-pagination"></div>-->
			...
			<div class="swiper-containeradvertisement">
				<div class="swiper-wrapper">
					<div class="addpic auto swiper-slide">
						...
						<div class="addpic auto swiper-slide">
							<a href="https://www.517ybang.com/biz/detail?id=37" target="_self">
							<img src="<?php echo CDN_URL ?>media/home/yhzx.jpg" />
							</a>
						</div>
						<div class="addpic auto swiper-slide">
							<a href="https://www.517ybang.com/biz/detail?id=45" target="_self">
							<img src="<?php echo CDN_URL ?>media/home/banner3.jpg" />
							</a>
						</div>
						<!--add-->
						<div class="addpic auto swiper-slide">
							<a href="https://www.517ybang.com/biz/detail?id=106" target="_self">
							<img src="<?php echo CDN_URL ?>media/home/banner4.jpg" />
							</a>
						</div>
						<div class="addpic auto swiper-slide">
							<a href="https://www.517ybang.com/biz/detail?id=124" target="_self">
						...
						<div class="addpic auto swiper-slide">
							<a href="https://www.517ybang.com/biz/detail?id=36" target="_self">
							<img src="<?php echo CDN_URL ?>media/home/banner2.png" />
							</a>
						</div>
				</div>
				...
				<div class="announcement auto">
					<!--左边图片区域-->
					<a href="https://www.517ybang.com/application/views/article/article_broadcast.html">
						<div class="pic">
			...
			<div class="coloroverlaycontent clearfix" style="margin-top:.14rem">
				...
				<div class="mid fl  dzcpinfo">
					<a href="https://www.517ybang.com/biz/detail?id=84" target="_self">
				...
				<div class="mid fl">
					<a href="https://www.517ybang.com/item/detail?id=2346" target="_self">
					<div class="midleft fr">
						<img src="https://cdn-remote.517ybang.com/media/home/shangjiabaopin/gnb.jpg" class="success">
						<h1>西班牙进口慕利酒园干红葡萄酒 纸袋装两支</h1>
						<!--<h2>1309 我的MAC</h2>-->
					</div>
					</a>
					<a href="https://www.517ybang.com/item/detail?id=2459" target="_self">
					<div class="midright fl">
						<img src="https://cdn-remote.517ybang.com/media/home/shangjiabaopin/qt.jpg" class="success">
						<h1>四川柠檬</h1>
						<!--<h2>爱疯 爱疯 疯</h2>-->
					</div>
					</a>
			...
			<div class="swiper-container7" style="border-radius: .2rem;display: none;" id="dzcplistInfo">
				    ...
				    <div class="swiper-slide">
				     <div class="list-group-item">
				      <a href="https://www.517ybang.com/biz/detail?id=2">
				       <div class="list">
				        <img src="https://medias.517ybang.com/item/url_image_main/201801/0104/143433.jpg" class="fl" />
				      ...
				      <a href="https://medias.517ybang.com/item/url_image_main/201801/0104/143433.jpg">
				       <div class="list">
				        <img src="https://medias.517ybang.com/item/url_image_main/201801/0104/143433.jpg" class="fl" />
				        <div class="listtext fr">
				         <span class="area">0.3km</span>
				...
				<div class="botWrap auto wid718 border20 mt10 clearfix">
					<div class="dotcontent clearfix bgfff border20">
						<ul>
							<a href="https://www.517ybang.com/item/detail?id=2595" target="_self">
							<li>
							...
							<a href="https://www.517ybang.com/item/detail?id=2548" target="_self">
							<li>
							...
							<a href="https://www.517ybang.com/item/detail?id=2553" target="_self">
							<li>
							...
							<a href="https://www.517ybang.com/item/detail?id=2588" target="_self">
							<li>
				...
				<div class="newgoodslist auto clearfix">
					<div class="twocol clearfix">
						<div class="goodsleft">
							<ul class="clearfix">
								<li>
									<a href="https://www.517ybang.com/item/detail?id=2597" target="_self">
									<div class="pic">
								...
								<li style="margin-left: .3rem;">
									<a href="https://www.517ybang.com/item/detail?id=2596" target="_self">
									<div class="pic">
						...
						<div class="goodsleft" style="margin-left:.1rem">
							<ul class="clearfix">
								<li>
									<a href="https://www.517ybang.com/item/detail?id=2589" target="_self">
									<div class="pic">
								...
								<li style="margin-left: .3rem;">
									<a href="https://www.517ybang.com/item/detail?id=2461" target="_self">
									<div class="pic">
					...
					<div class="threecol">
						<ul>
							<li>
								<a href="https://www.517ybang.com/item/detail?id=2279" target="_self">
								<div class="pic">
							...
							<li>
								<a href="https://www.517ybang.com/item/detail?id=2381" target="_self">
								<div class="pic">
							...
							<li style="margin-right:0">
								<a href="https://www.517ybang.com/item/detail?id=2464" target="_self">
								<div class="pic">
				...
				<div class="onlinegroup clearfix">
					...
					<div class="onlinegroupcontent wid718 auto mt10">
						<div class="onlinegoodsleft">
							...
							<a href="https://www.517ybang.com/item/detail?id=2507" target="_self">
							<div class="pic">
						...
						<div class="onlinegoodsright fr">
							<div class="onlinegoodstop">
								<ul>
									<li>
										<a href="https://www.517ybang.com/item/detail?id=2415" target="_self">
										<div class="pic">
									...
									<li>
										<a href="https://www.517ybang.com/item/detail?id=2281" target="_self">
										<div class="pic">
							...
							<div class="onlinegoodstop" style="margin-top:.1rem">
								<ul>
									<li>
										<a href="https://www.517ybang.com/item/detail?id=2417" target="_self">
										<div class="pic">
									...
									<li>
										<a href="https://www.517ybang.com/item/detail?id=2366" target="_self">
										<div class="pic">
			...
			<div class="coloroverlaycontent clearfix" id="morelist">
				...
				<div class="left fl refreshcontent">
					<a href="https://www.517ybang.com/biz/detail?id=130" target="_self">
						<div class="bgefefef">
				...
				<div class="mid fl" style="margin-top:.1rem !important">
					...
					<div class="midright fr refreshcontent">
						<a href="https://www.517ybang.com/biz/detail?id=116" target="_self">
				...
				<div class="fl" style="margin-top:.1rem">
					<div class="midleft refreshcontent">
						<a href="https://www.517ybang.com/biz/detail?id=1">
							<div class="bgefefef">
				...
				<div class="botWrap auto wid718 border20 fl mt10 clearfix">
					<div class="dotcontent clearfix bgfff border20">
						<ul>
							<a href="https://www.517ybang.com/item/detail?id=574" target="_self">
							<li>
							...
							<li>
								<a href="https://www.517ybang.com/item/detail?id=2249" target="_self">
							...
							<li>
								<a href="https://www.517ybang.com/item/detail?id=2337" target="_self">
							...
							<li>
								<a href="https://www.517ybang.com/item/detail?id=357" target="_self">
			...
			<div class="coloroverlaycontent clearfix" style="margin-top:.14rem">
				...
				<div class="mid fl  lsjxinfo">
					<a href="https://www.517ybang.com/biz/detail?id=53" target="_self">
					<div class="midright fr mt0">
						<div class="bgefefef">
				...
				<div class="mid fl">
					<a href="https://www.517ybang.com/biz/detail?id=46" target="_self">
					<div class="midleft fr">
						<img src="https://cdn-remote.517ybang.com/media/home/nongchanpin/mmltx.jpg" class="success">
					...
					<a href="https://www.517ybang.com/biz/detail?id=1" target="_self">
					<div class="midright fl">
						<img src="https://cdn-remote.517ybang.com/media/home/nongchanpin/stm.jpg" class="success">
						<h1>硕泰米</h1>
						<!--<h2>爱疯 爱疯 疯</h2>-->
					</div>
					</a>
			...
			<div class="swiper-container7" style="margin-top:.1rem;border-radius: .2rem;display: none;" id="lsjxinfo">
				   <div class="swiper-wrapper">
				    <div class="swiper-slide">
				     <div class="list-group-item">
				      <a href="https://www.517ybang.com/biz/detail?id=2">
				       <div class="list">
				        <img src="https://cdn-remote.517ybang.com/media/home/nongchanpin/njzysc.jpg" class="fl" />
				        <div class="listtext fr">
				         <span class="area">0.3km</span>
				         <h1>韦博英语韦博英语韦博英语韦博英语韦博英语(麦岛分路店)</h1>
				         <div class="star">
				      ...
				      <a href="https://www.517ybang.com/biz/detail?id=2">
				       <div class="list">
				        <img src="https://cdn-remote.517ybang.com/media/home/nongchanpin/lysqz.jpg" class="fl" />
				        <div class="listtext fr">
				         <span class="area">0.3km</span>
				         <h1>韦博英语韦博英语韦博英语韦博英语韦博英语(麦岛分路店)</h1>
				         <div class="star">
				...
				<div class="botWrap auto wid718 border20 mt10 clearfix">
					<div class="dotcontent clearfix bgfff border20">
						<ul>
							<a href="https://www.517ybang.com/item/detail?id=2322" target="_self">
							<li>
							...
							<a href="https://www.517ybang.com/item/detail?id=2440" target="_self">
							<li>
							...
							<a href="https://www.517ybang.com/item/detail?id=2458" target="_self">
							<li>
							...
							<a href="https://www.517ybang.com/item/detail?id=2447" target="_self">
							<li>
			...
			<div class="coloroverlaycontent clearfix" style="margin-top:.1rem">
				   ...
				   <div class="swiper-wrapper">
				    <div class="swiper-slide">
				     <div class="list-group-item">
				      <a href="https://www.517ybang.com/biz/detail?id=2">
				       <div class="list">
				        <img src="https://cdn-remote.517ybang.com/media/slider1-2.png" class="fl" />
				        <div class="listtext fr">
				         <span class="area">0.3km</span>
				         <h1>韦博英语韦博英语韦博英语韦博英语韦博英语(麦岛分路店)</h1>
				         <div class="star">
				...
				<div class="botWrap auto wid718 border20 fl mt10 clearfix">
					<div class="dotcontent clearfix bgfff border20">
						<ul>
							<a href="https://www.517ybang.com/item/detail?id=2603" target="_self">
							<li>
								<img data-src="<?php echo CDN_URL ?>media/home/yundongjiankang/160x160_0.jpg" class="auto block">
								<h1>【预售3-5天送达】Apple iPhone X  256GB 银色</h1>
								<h2>¥799.00</h2>
							</li>
							</a>
							<a href="https://www.517ybang.com/item/detail?id=2347" target="_self">
							<li>
							...
							<a href="https://www.517ybang.com/item/detail?id=2467" target="_self">
							<li>
			...
			<div class="swiper-container7" style="margin-top:.1rem;border-radius: .2rem;display: none;" id="gxzkinfo">
				   <div class="swiper-wrapper">
				    <div class="swiper-slide">
				     <div class="list-group-item">
				      <a href="https://www.517ybang.com/biz/detail?id=2">
				       <div class="list">
				        <img src="https://cdn-remote.517ybang.com/media/home/dianzichanpin/dzcp/160x160_0.jpg" class="fl" />
				        <div class="listtext fr">
				         <span class="area">0.3km</span>
				         <h1>韦博英语韦博英语韦博英语韦博英语韦博英语(麦岛分路店)</h1>
				         <div class="star">
				      ...
				      <a href="https://www.517ybang.com/biz/detail?id=2">
				       <div class="list">
				        <img src="https://cdn-remote.517ybang.com/media/home/dianzichanpin/dzcp/160x160_3.jpg" class="fl" />
				        <div class="listtext fr">
				         <span class="area">0.3km</span>
				         <h1>韦博英语韦博英语韦博英语韦博英语韦博英语(麦岛分路店)</h1>
				         <div class="star">
				...
				<div class="botWrap auto wid718 border20 mt10 clearfix">
					<div class="dotcontent clearfix bgfff border20">
						<ul>
							<a href="https://www.517ybang.com/item/detail?id=2624">
							<li>
							...
							<a href="https://www.517ybang.com/item/detail?id=2620">
							<li>
							...
							<a href="https://www.517ybang.com/item/detail?id=2619">
							<li>
							...
							<a href="https://www.517ybang.com/item/detail?id=2628">
							<li>
				...
				<div class="like wid718 auto clearfix mt10">
					<ul>
						<a href="https://www.517ybang.com/item/detail?id=4103" target="_self">
						<li>
						...
						<a href="https://www.517ybang.com/item/detail?id=4020" target="_self">
						<li>
						...
						<a href="https://www.517ybang.com/item/detail?id=3907" target="_self">
						<li class="mr0">
						...
						<a href="https://www.517ybang.com/item/detail?id=3971" target="_self">
						<li>
						...
						<a href="https://www.517ybang.com/item/detail?id=4187" target="_self">
						<li>
						...
						<a href="https://www.517ybang.com/item/detail?id=4056" target="_self">
						<li class="mr0">
						...
						<div class="module-indexed-box">
							...
							<div>
								<p data-group="最近" class="module-address module-limit-before">
								 ...
								 <div class="recent-area clear"  id="recentcitycur">
...
$(document).ready(function() {
	...
	$("#more").on("click", function() {
		...
		items.on('click',function(){
			...
			switch(titleName){
				case '鱼哥' :
				$('#newmorelist').find('img').attr('src','https://cdn-remote.517ybang.com/media/home/shangjiasouluo/sjss/160x160_3.jpg');
				break;
				case '澳滋' :
				$('#newmorelist').find('img').attr('src','https://cdn-remote.517ybang.com/media/home/shangjiasouluo/sjss/160x160_0.jpg');
				break;
				case '君博' :
				$('#newmorelist').find('img').attr('src','https://cdn-remote.517ybang.com/media/home/shangjiasouluo/sjss/160x160_2.jpg');
				break;
	...
	function storm(el,wrap,icon) {
		...
		$(".refreshcontent").hide();
		var titleName = $('.toMove').find('b').text();
		var oAddYuge = '<div class="swiper-container7" id="newmorelist" style="margin-top:.1rem;border-radius: .2rem;"><div class="swiper-wrapper"><div class="swiper-slide"><div class="list-group-item"><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_3.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>鱼哥</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_3.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>鱼哥</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_3.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>鱼哥</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_3.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>鱼哥</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_3.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>鱼哥</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_3.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>鱼哥</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a></div></div></div></div>';
		var oAddJunbo = '<div class="swiper-container7" id="newmorelist" style="margin-top:.1rem;border-radius: .2rem;"><div class="swiper-wrapper"><div class="swiper-slide"><div class="list-group-item"><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_2.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>君博</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_2.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>君博</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_2.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>君博</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_2.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>君博</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_2.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>君博</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_2.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>君博</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a></div></div></div></div>';
		var oAddAozi = '<div class="swiper-container7" id="newmorelist" style="margin-top:.1rem;border-radius: .2rem;"><div class="swiper-wrapper"><div class="swiper-slide"><div class="list-group-item"><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_0.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>澳滋</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_0.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>澳滋</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_0.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>澳滋</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_0.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>澳滋</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_0.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>澳滋</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a><a href="https://www.517ybang.com/biz/detail?id=2"><div class="list"><img src="<?php echo CDN_URL ?>media/home/shangjiasouluo/sjss/160x160_0.jpg" class="fl"><div class="listtext fr"><span class="area">0.3km</span><h1>澳滋</h1><div class="star"><ul><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li><li><i class="icon-weixuanzhong2"></i></li></ul></div><div class="tag">麦岛路沿线   英语</div><div class="allbuy"><span class="tuan">团</span><span>99元 单人体验一次</span></div></div></div></a></div></div></div></div>';
		switch(titleName){
			case '鱼哥' : 
