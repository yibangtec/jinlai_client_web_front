    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
            	<a href="https://www.517ybang.com/biz/detail?id=93" target="_self">
                	<img src="<?php echo CDN_URL ?>media/page/xxjy/xxjy1.jpg">
                </a>
            </div>
            <!--<div class="swiper-slide">
                <img src="<?php echo CDN_URL ?>media/page/xxjy/xxjy2.jpg">
            </div>
            <div class="swiper-slide">
                <img src="<?php echo CDN_URL ?>media/page/xxjy/xxjy3.jpg">
            </div>
            <div class="swiper-slide">
                <img src="<?php echo CDN_URL ?>media/page/xxjy/xxjy4.jpg">
            </div>-->
...
<!--<div class="classification auto">
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            ...
            <div class="move">
                <span class="titletext">升学辅导</span>
        ...
        <div class="swiper-slide">
            ...
            <i class="freshshowbg colorareaBlue"></i>
            <div class="move">
            <span class="titletext">兴趣生活</span>
...
<div class="experience wid710 auto">
    <div class="experience_one fl">
        ...
        <a href="https://www.517ybang.com/biz/detail?id=132" target="_self">
        <div class="goodpic auto">
            <img src="<?php echo CDN_URL ?>media/page/xxjy/huaerjie@3x.png">
        </div>
        <h1>门萨教育集团</h1>
        <h2>打开孩子智慧之门</h2>
    ...
    <div class="experience_two fr">
    	<a href="https://www.517ybang.com/biz/detail?id=110" target="_self">
        <div class="card_one ml0">
            <img src="<?php echo CDN_URL ?>media/page/xxjy/wodeer@3x.png" class="fl">
            <h1 class="mt10">卡尔熊外语学校</h1>
            <h2>真正的英语母语环境</h2>
            <a href="###" class="atonce mrcur">立即体验</a>
        </div>
        </a>
        <a href="https://www.517ybang.com/biz/detail?id=129" target="_self">
        <div class="card_one mt10 ml0">
            <img src="<?php echo CDN_URL ?>media/page/xxjy/zhimajie@3x.png" class="fl">
            <h1 class="mt10">嘉艺形体培训</h1>
            <h2>从内到外的蜕变</h2>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide list-group">
						<div class="list-group-item">
							<div class="list">
								<div class="line"></div>
			            		<img src="<?php echo CDN_URL ?>media/page/xxjy/bominghan@3x.png" class="fl">
            			...
            			<div class="allbuy">
            				...
            				<span>99元 单人团课体验1次</span>
            			</div>
            		</div>
            	</div>
            	<div class="list">
			            		<img src="<?php echo CDN_URL ?>media/page/xxjy/li_weibo@3x.png" class="fl">
			            		<div class="listtext fr">
		            			<!--显示距离-->
		            			<span class="area">0.3km</span>
		            			<h1>英联雅思(麦岛路分店)</h1>
					...
					<div class="swiper-slide list-group">
						<div class="list-group-item">
							<div class="list">
			            		<img src="<?php echo CDN_URL ?>media/page/xxjy/li_yinglian@3x.png" class="fl">
			            		<div class="listtext fr">
		            			<!--显示距离-->
		            			<span class="area">0.3km</span>
		            			<h1>伯明汉英语</h1>
					...
					<div class="swiper-slide list-group">
						<div class="list-group-item">
							<div class="list">
								<div class="line"></div>
			            		<img src="<?php echo CDN_URL ?>media/page/xxjy/li_zhimajie@3x.png" class="fl">
			            		<div class="listtext fr">
		            			<!--显示距离-->
		            			<span class="area">0.3km</span>
		            			<h1>芝麻街英语</h1>
