    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
            	<a href="https://www.517ybang.com/biz/detail?id=76" target="_self">
...
<div class="experience wid710 auto">
    <div class="experience_one fl">
        ...
        <div class="goodpic auto">
            <img src="<?php echo CDN_URL ?>media/page/gsms/zhaxie@3x.png">
        </div>
        <h1>52健身</h1>
        <h2>释放运动激情</h2>
        </a>
       <!-- <a href="###" class="atonce">立即体验</a>-->
       <a href="###" class="atonce atonce_r price_market">¥125.00</a>
    ...
    <div class="experience_two fr">
        ...
        <div class="card_one ml0">
            <img src="<?php echo CDN_URL ?>media/page/gsms/xiaolongxia@3x.png" class="fl">
            <h1 class="mt10">英睿健身</h1>
            <h2>成就品质生活</h2>
            </a>
           <a href="###" class="atonce atonce_r price_market">¥124.00</a>
       <div class="market_buycar addcar">
                <i class="icon-buy"></i>
            </div>
        </div>
        <div class="card_one mt10 ml0">
        	<a href="https://www.517ybang.com/biz/detail?id=70" target="_self">
            <img src="<?php echo CDN_URL ?>media/page/gsms/pizza@3x.png" class="fl">
            <h1 class="mt10">时代星动力健身</h1>
            <h2>塑造健康魅力</h2>
            </a>

          <a href="###" class="atonce atonce_r price_market">¥200.00</a>
       <div class="market_buycar addcar">
                <i class="icon-buy"></i>
            </div>
	...
	<div class="swiper-container6" style="display: none;">
		<div class="swiper-wrapper w">
			<div class="swiper-slide d">
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide list-group">
						<div class="list-group-item">
							<div class="list">
								<div class="line"></div>
			            		<img src="<?php echo CDN_URL ?>media/page/gsms/shihao@3x.png" class="fl">
            	...
            	<div class="list">
			            		<img src="<?php echo CDN_URL ?>media/page/gsms/zhaxie@3x.png" class="fl">
			            		<div class="listtext fr">
		            			<!--显示距离-->
		            			<span class="area">0.3km</span>
		            			<h1>永琪美容美发</h1>
