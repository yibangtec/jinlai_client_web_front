...
<script>
	...
	console.log(items);
        ...
        for(var i=0;i<arr.length;i++){
          		...
          		if(i == 0){
          		    goodsListContent = '<h2>'+
                                           '<a href="<?php echo base_url('item/index?biz_id='.$biz_id) ?>&category_biz_id='+arr[i].category_id+'" class="negotiate border-active">'+
                                               '<span>'+arr[i].name+'</span><span class="see-all">查看全部</span>'+
                                           '</a>'+
                                       '</h2>';
          		}else{
          		    goodsListContent = '<h2>'+
                                            '<a href="<?php echo base_url('item/index?biz_id='.$biz_id) ?>&category_biz_id='+arr[i].category_id+'" class="negotiate">'+
                                                '<span>'+arr[i].name+'</span><span class="see-all">查看全部</span>'+
                                            '</a>'+
                                        '</h2>';
                }
