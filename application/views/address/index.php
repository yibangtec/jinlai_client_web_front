...
<script>
$(function(){
    var default_address_id = '<?php echo $this->session->address_id ?>';
    	...
    	var addressHtml = '<div class="address-list">'+
                                  ...
                                  '<div class="address-operation clearfix">'+
                                     '<div class="title-left select"><i class="'+ defaultIcon +'"></i> <span>'+defaultText+'</span></div>'+
                                      '<div class="title-right"><span class="operation-del"><i class="icon-del"></i> 删除</span><a href="<?php echo base_url('address/edit') . "?&id='+items[key].address_id+'" ?>" class="operation-type"><i class="icon-write"></i> 编辑</a></div>'+
                                  '</div>'+
                              '</div>';
