    ...
    <style>
        ...
        *, *:before, *:after {-webkit-tap-highlight-color: rgba(0, 0, 0, 0);}
        ...
        .box {width: 100%; height: 100%;position: relative;font-size: 0.26rem}
        .goods-img{
            height: 7.5rem;
            width: 100%;
        }
        ...
        .bgc{
            ...
            bottom: 0;
            left: 0;
            background: url("<?php echo CDN_URL ?>media/share/goodsbg.jpg") no-repeat;
    ...
    <div class="box">
        ...
        <div class="bgc">
            ...
            <img class="goods-erweima" src="<?php echo CDN_URL ?>media/share/erweima.png" alt=""/>
        </div>
    </div>
